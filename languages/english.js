...
module.exports = class {
    constructor() {
		this.language = {
			...
			CONFIGURATION_WELCOME: (imageEnabled, color, channelID) => `Channel : <#${channelID}>\nImage : ${imageEnabled ? "Yes\nColor : "+color : "No"}`,
			CONFIGURATION_GOODBYE: (imageEnabled, color, channelID) => `Channel : <#${channelID}>\nImage : ${imageEnabled ? "Yes\nColor : "+color : "No"}`,
			...
			WELCOME_FORM_MESSAGE: (channel, msg) => `All right! The messages will therefore be sent in ${channel}. Enter the welcome message below: \n\nInfos:\`\`\`\nMention: {user}\nMembers: {membercount}\nServer: {server}\`\`\`For example, "Welcome {user} to {server} ! Thanks to you, we are {membercount} !" will give "Welcome ${msg.author} to ${msg.guild.name} ! Thanks to you, we are ${msg.guild.memberCount} !".`,
			...
			WELCOME_FORM_COLOR: "Very good! Now choose the color of the welcome image using a hexadecimal code: \`#FFFFFF\`, or among this list: \`white, orange, red, blue, green ou purple\`",
			WELCOME_FORM_SUCCESS_COLOR: (color, channel, prefix) => `${e.success} | Welcome messages enabled in <#${channel}> with the color \`${color}\`! Type \`${prefix}welcome test\` to test the welcome message and type \`${prefix}welcome color\` to change color!`,
			WELCOME_SUCCESS_COLOR: (color, prefix) => `${e.success} | The color of the welcome image is now: \`${color}\`! Type \`${prefix}welcome test\` to test the welcome message!`,
			WELCOME_ERR_COLOR: `${e.error} | The color does not exist or the hexadecimal code is not valid! Use a color from the list: \`white, orange, red, blue, green ou purple\` or a code in this format: \`#FFFFFF\`!`,
			...
			GOODBYE_FORM_MESSAGE: (channel, msg) => `All right! The messages will therefore be sent in ${channel}. Enter the goodbye message below: \n\nInfos:\`\`\`\nMention: {user}\nMembers: {membercount}\nServer: {server}\`\`\`For example, "Goodbye {user} ! It's sad, without you we're only {membercount} on {server} !" will give "Goodbye ${msg.author.username}#${msg.author.discriminator} ! It's sad, without you we're only ${msg.guild.memberCount} on ${msg.guild.name} !".`,
			...
			GOODBYE_FORM_COLOR: "Very good! Now choose the color of the goodbye image using a hexadecimal code: \`#FFFFFF\`, or among this list: \`white, orange, red, blue, green ou purple\`",
			GOODBYE_FORM_SUCCESS_COLOR: (color, channel, prefix) => `${e.success} | Goodbye messages enabled in <#${channel}> with the color \`${color}\`! Type \`${prefix}goodbye test\` to test the goodbye message and type \`${prefix}goodbye color\` to change color!`,
			GOODBYE_SUCCESS_COLOR: (color, prefix) => `${e.success} | The color of the goodbye image is now: \`${color}\`! Type \`${prefix}goodbye test\` to test the goodbye message!`,
			GOODBYE_ERR_COLOR: `${e.error} | The color does not exist or the hexadecimal code is not valid! Use a color from the list: \`white, orange, red, blue, green ou purple\` or a code in this format: \`#FFFFFF\`!`,

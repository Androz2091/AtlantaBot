...
module.exports = class Member {
    ...
    calcMoney() {
        ...
        this.bank = (this.transactions.filter((t) => t.action === "bank").map((t) => t.debit - t.credit).length ? this.transactions.filter((t) => t.action === "bank").map((t) => t.debit - t.credit) : [0]).reduce((p, c) => p + c);
    }

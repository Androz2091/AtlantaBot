...
class Welcome extends Command {
    ...
    async run (message, args, data) {
        ...
        if(args[0] === "color" && data.settings.plugins.welcome.enabled && data.settings.plugins.welcome.image.enabled){
            //Color ?
            if(args[1]){
                // Hexadecimal value
                if(args[1].startsWith("#")){
                    ...
                    if(hexacolor.length === 6){
                        data.settings.plugins.welcome.image.color = "#"+hexacolor.toUpperCase();
                        data.settings.markModified("plugins.welcome");
                        data.settings.save();
                        return message.channel.send(message.language.get("WELCOME_SUCCESS_COLOR", data.settings.plugins.welcome.image.color, data.settings.prefix));
                    } else {
                ...
                if(args[1] === "white" || args[1] === "orange" || args[1] === "red" || args[1] === "blue" || args[1] === "green" || args[1] === "purple"){
                    data.settings.plugins.welcome.image.color = args[1].toLowerCase();
                    data.settings.markModified("plugins.welcome");
                    data.settings.save();
                    return message.channel.send(message.language.get("WELCOME_SUCCESS_COLOR", data.settings.plugins.welcome.image.color, data.settings.prefix));
                } else {
        ...
        collector.on("collect", async (msg) => {
            ...
            if(welcome.message && !welcome.image.enabled){
            ...
            if(welcome.image.enabled){
                if(msg.content.startsWith("#")){
                    ...
                    hexacolor = color.replace(/[^a-z0-9]/gi, "");
                    if(hexacolor.length === 6){
                        welcome.image.color = "#"+hexacolor.toUpperCase();
                        message.channel.send(message.language.get("WELCOME_FORM_SUCCESS_COLOR", welcome.image.color, welcome.channel, data.settings.prefix));
                        data.settings.plugins.welcome = welcome;
                        data.settings.markModified("plugins.welcome");
                        await data.settings.save();
                        return collector.stop();
                ...
                if(msg.content === "white" || msg.content === "orange" || msg.content === "red" || msg.content === "blue" || msg.content === "green" || msg.content === "purple"){
                    welcome.image.color = msg.content.toLowerCase();
                    message.channel.send(message.language.get("WELCOME_FORM_SUCCESS_COLOR", welcome.image.color, welcome.channel, data.settings.prefix));
                    data.settings.plugins.welcome = welcome;
                    data.settings.markModified("plugins.welcome");
                    await data.settings.save();

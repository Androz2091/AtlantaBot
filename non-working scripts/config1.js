module.exports = {
	...
	token: "NzIwOTQ0NjA3MTYwMDQxNTMy.XuNWOA.r4ELVrcrpJScYxmwJN574g7gepQ",
	...
	dashboard: {
		...
		baseURL: "https://google.com", // The base URl of the dashboard
		logs: "XXXXXXXXXXX", // The channel ID of logs
		port: 8080, // Dashboard port
		expressSessionPassword: "XXXXXXXXXXX", // Express session password (it can be what you want)
		failureURL: "https://google.com" // url on which users will be redirected if they click the cancel button (discord authentication)
	},
	mongoDB: "mongodb://localhost:27017/ppbot", // The URl of the mongodb database
	prefix: "pp", // The default prefix for the bot
	/* For the embeds (embeded messages) */
	embed: {
		color: "#0091fc", // The default color for the embeds
		footer: "PP bot | Beta" // And the default footer for the embeds
	},
	defaultLanguage: "english", // The default language for the new servers
	botname: "PPbot", // The name of the bot
	...
	others: {
		github: "https://www.google.com", // Founder's github account
		donate: "https://www.google.com" // Donate link
	},
	...
	status: [
		{
			name: "@PP help on {serversCount} servers",
			type: "LISTENING"
		},
		{
			name: "PP",

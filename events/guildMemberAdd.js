            ...
            if(settings.plugins.welcome.enabled){
                ...
                if(channel){
                    ...
                    if(settings.plugins.welcome.withImage){
                        ...
                        if(settings.plugins.welcome.color.enabled){
                            if(settings.plugins.welcome.color.color.startsWith("#")){
                                ctx.fillStyle = settings.plugins.welcome.color.color;
                                }
                            if(settings.plugins.welcome.color.color === "white"){
                                ctx.fillStyle = "#ffffff";
                                }
                            if(settings.plugins.welcome.color.color === "orange"){
                                gradient.addColorStop(0, "#e15500"); 
                                gradient.addColorStop(1, "#e7b121");
                                ctx.fillStyle = gradient;
                                }
                            if(settings.plugins.welcome.color.color === "red"){
                                gradient.addColorStop(0, "#a00707");
                                gradient.addColorStop(1, "#de0c0c");
                                ctx.fillStyle = gradient;
                                }
                            if(settings.plugins.welcome.color.color === "blue"){
                                gradient.addColorStop(0, "#00c4ff");
                                gradient.addColorStop(1, "#0074ff");
                                ctx.fillStyle = gradient;
                                }
                            if(settings.plugins.welcome.color.color === "green"){
                                gradient.addColorStop(0, "#4caf50");
                                gradient.addColorStop(1, "#26832a");
                                ctx.fillStyle = gradient;
                                }
                            if(settings.plugins.welcome.color.color === "purple"){

...
module.exports = class {
    constructor() {
		this.language = {
			...
			CONFIGURATION_WELCOME: (imageEnabled, color, channelID) => `Salon : <#${channelID}>\nImage : ${imageEnabled ? "Oui\nCouleur : "+color : "Non"}`,
			CONFIGURATION_GOODBYE: (imageEnabled, color, channelID) => `Salon : <#${channelID}>\nImage : ${imageEnabled ? "Oui\nCouleur : "+color : "Non"}`,
			...
			WELCOME_FORM_COLOR: "Très bien ! Maintenant choisissez la couleur de l'image de bienvenue en utilisant un code hexadécimal: \`#FFFFFF\`, ou parmis cette liste: \`white, orange, red, blue, green ou purple\`",
			WELCOME_FORM_SUCCESS_COLOR: (color, channel, prefix) => `${e.success} | Messages de bienvenue activés dans <#${channel}> avec la couleur \`${color}\` ! Tapez \`${prefix}welcome test\` pour tester le message de bienvenue et tapez \`${prefix}welcome color\` pour changer de couleur !`,
			WELCOME_SUCCESS_COLOR: (color, prefix) => `${e.success} | La couleur de l'image de bienvenue est désormais: \`${color}\` ! Tapez \`${prefix}welcome test\` pour tester le message de bienvenue !`,
			WELCOME_ERR_COLOR: `${e.error} | La couleur n'existe pas ou le code hexadecimal n'est pas valide ! Utilisez une couleur de la liste: \`white, orange, red, blue, green ou purple\` ou un code sous ce format: \`#FFFFFF\` !`,
			...
			GOODBYE_FORM_COLOR: "Très bien ! Maintenant choisissez la couleur de l'image d'au revoir en utilisant un code hexadécimal: \`#FFFFFF\`, ou parmis cette liste: \`white, orange, red, blue, green ou purple\`",
			GOODBYE_FORM_SUCCESS_COLOR: (color, channel, prefix) => `${e.success} | Messages d'au revoir activés dans <#${channel}> avec la couleur \`${color}\` ! Tapez \`${prefix}goodbye test\` pour tester le message d'au revoir et tapez \`${prefix}goodbye color\` pour changer de couleur !`,
			GOODBYE_SUCCESS_COLOR: (color, prefix) => `${e.success} | La couleur de l'image d'au revoir est désormais: \`${color}\` ! Tapez \`${prefix}goodbye test\` pour tester le message d'au revoir !`,
			GOODBYE_ERR_COLOR: `${e.error} | La couleur n'existe pas ou le code hexadecimal n'est pas valide ! Utilisez une couleur de la liste: \`white, orange, red, blue, green ou purple\` ou un code sous ce format: \`#FFFFFF\` !`,

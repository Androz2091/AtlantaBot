...
| **help**         | Show commands list or informations about a command.               | help (command)                 | 5 seconds |
| **invitations**  | Shows the number of people you have invited to the server!        | invitations (@member)          | 3 seconds |
| **invite**       | Shows the links of Atlanta!                                       | invite (copy)                  | 5 seconds |
...
| **staff**        | Shows the list of server staff members!                           | staff                          | 3 seconds |
| **stats**        | Shows the stats of the bot!                                       | stats                          | 3 seconds |
| **suggest**      | Send your suggestion to the channel defined for them!             | suggest [message]              | 5 seconds |
| **translate**    | I translate your text!                                            | translate [language] [message] | 8 seconds |
...
| **deletemod**       | Enable or disable the auto deletion of moderation commands! | deletemod [on/off]               | 3 seconds  |
| **goodbye**         | Enable or disable the goodbye messages!                     | goodbye                          | 3 seconds  |
| **ignore**          | Disable or enable commands in a channel                     | ignore [channel]                 | 3 seconds  |
...
| **slowmode**        | Set a cooldown in a channel                                 | slowmode [#channel] (time)       | 3 seconds  |
| **welcome**         | Enable/Disable welcome messages in the server!              | welcome                          | 3 seconds  |
...
| **qrcode**        | Generates a QR code image from your word            | qrcode [text]              | 3 seconds |
...
| **tweet**         | Generates a "triggered" image using Nekobot API     | triggered (@member)        | 5 seconds |
...
| Name             | Description                                                            | Usage                            | Cooldown   |
| ---------------- | ---------------------------------------------------------------------- | -------------------------------- | ---------- |
| **achievements** | Shows the list of all the achievements!                                | achievements                     | 1 seconds  |
...
| **choice**    | Randomly pick one of the choices you give me!                                                 | choice [choice1/choice2/etc...] | 5 seconds |
| **findwords** | Start a game of findwords, a game you have to find words!                                     | findwords                       | 5 seconds |
| **flip**      | I roll the dice for you!                                                                      | flip                            | 1 seconds |
| **fml**       | Gets a random FML                                                                             | fml                             | 3 seconds |
| **joke**      | Gets a wonderful joke for you!                                                                | joke                            | 3 seconds |
...
| Name       | Description                                | Usage              | Cooldown  |
| ---------- | ------------------------------------------ | ------------------ | --------- |
| **lyrics** | Shows the lyrics of a song                 | lyrics [song-name] | 5 seconds |
| **np**     | Shows informations about the current song! | np                 | 5 seconds |

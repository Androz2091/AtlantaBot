...
Canvas.registerFont(resolve("./src/assets/fonts/Burbank-Big-Condensed-Bold-Font.otf"), { family: "Burbank" });
Canvas.registerFont(resolve("./src/assets/fonts/KeepCalm-Medium.ttf"), { family: "KeepCalm" });

...
module.exports = class extends Command {
    ...
    async execute(message) {
        ...
        player.queue.forEach((song, index) => {
            ...
            lastEmbed.addField(index === 0 ? message.translate("music/queue:CURRENTLY_PLAYING") : `#${index+1}`, message.translate("music/queue:SONG", {
                songTitle: song.title,
                songDuration: this.client.helpers.convertTime.execute(message.guild, song.duration),

        ...
        member.guild.fetch().then(async (guild) => {
            ...
            if(settings.plugins.goodbye.enabled){
                ...
                if(channel){
                    ...
                    if(settings.plugins.goodbye.image.enabled){
                        ...
                        if(settings.plugins.goodbye.image.color){
                            if(settings.plugins.goodbye.image.color.startsWith("#")){
                                ctx.fillStyle = settings.plugins.goodbye.image.color;
                                }
                            if(settings.plugins.goodbye.image.color === "white"){
                                ctx.fillStyle = "#ffffff";
                                }
                            if(settings.plugins.goodbye.image.color === "orange"){
                                gradient.addColorStop(0, "#e15500"); 
                                gradient.addColorStop(1, "#e7b121");
                                ctx.fillStyle = gradient;
                                }
                            if (settings.plugins.goodbye.image.color === "red"){
                                gradient.addColorStop(0, "#a00707");
                                gradient.addColorStop(1, "#de0c0c");
                                ctx.fillStyle = gradient;
                                }
                            if (settings.plugins.goodbye.image.color === "blue"){
                                gradient.addColorStop(0, "#00c4ff");
                                gradient.addColorStop(1, "#0074ff");
                                ctx.fillStyle = gradient;
                                }
                            if (settings.plugins.goodbye.image.color === "green"){
                                gradient.addColorStop(0, "#4caf50");
                                gradient.addColorStop(1, "#26832a");
                                ctx.fillStyle = gradient;
                                }
                            if (settings.plugins.goodbye.image.color === "purple"){
